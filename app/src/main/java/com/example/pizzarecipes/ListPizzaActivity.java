    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ps.create(new Produit(
                ...
                "STEP 1:\n\n In large bowl, dissolve yeast and sugar in water; let stand for 5 minutes. " +
                        ...
                        "Place in a greased bowl, turning once to grease the top. Cover and let rise in a warm place " +
                        "until doubled, about 45 minutes. Meanwhile, cook beef and onion over medium heat until no longer pink; drain.\n\n" +
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Produit selectedProduct = ps.findAll().get(position);
                // Créer une nouvelle Intent pour démarrer l'activité ProductDetailActivity
                Intent intent = new Intent(ListPizzaActivity.this, DetailsActivity.class);
                intent.putExtra("productName", selectedProduct.getNom());
                intent.putExtra("productImage", selectedProduct.getPhoto());
                intent.putExtra("productDescription", selectedProduct.getDescription());
                intent.putExtra("productIngredients", selectedProduct.getDetailsIngred());
                intent.putExtra("productPreparation", selectedProduct.getPreparation());

                // Démarrer l'activité ProductDetailActivity
